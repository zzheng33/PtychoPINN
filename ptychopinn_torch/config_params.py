...
class DatagenConfig:
    ...
    #Objects currently supported, this may be added to or documentation updated at some point in time
    object_class: Literal['procedural', 'polyhedra','dead_leaves','white_noise',
                          'simplex_noise','blurred_white_noise','unspecified'] = 'unspecified'
