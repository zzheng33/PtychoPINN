...
Power CSV files and reconstruction outputs from the Aurora/Intel wrapper are written under the repository:

```bash
/home/john/PtychoPINN/power_experiments
```

For example:

```text
/home/john/PtychoPINN/power_experiments/Max/TP1/bs32_power.csv
/home/john/PtychoPINN/power_experiments/Max/TP1/bs32_outputs/
```
